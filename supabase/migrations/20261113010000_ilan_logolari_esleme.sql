/*
  İLAN LOGOLARI — 26 EYLÜL 2026 TESLİMİ (eşleme)

  Kaynak: scripts/sql/ilan-logolari-2026-09-26.sql (teslim notu:
  docs/ilan-logo-teslimi-2026-09-26.md). Görseller PR #271 ile
  `public/isveren-logolari/` altında canlıya çıktı ve adresleri açıldı;
  bu göç yalnız eşlemeyi yazıyor.

  Her satır şirket kimliği VE adıyla eşleşiyor ve yalnız `logo_url`
  hâlâ boşsa yazıyor: araya başka bir logo girildiyse üzerine yazılmıyor.
  Gövde teslimdeki dosyayla aynı; yalnız `begin`/`commit` çıkarıldı
  (göç zaten tek işlemde koşuyor).

  NREL bu teslimin dışında: iki NREL ilanı baş harfli kutuda kalıyor.

  GERİ ALMA (yalnız bu göçün yazdıklarını boşaltır):
    update public.companies set logo_url = null
     where logo_url in (
       'https://stajimvar.com/isveren-logolari/hellmann-worldwide-logistics.svg',
       'https://stajimvar.com/isveren-logolari/vylor-icon.png',
       'https://stajimvar.com/isveren-logolari/bigger-games.svg',
       'https://stajimvar.com/isveren-logolari/wongdoody.jpg',
       'https://stajimvar.com/isveren-logolari/neckar-hub.png',
       'https://stajimvar.com/isveren-logolari/yami-studios-og.jpg',
       'https://stajimvar.com/isveren-logolari/qubbe-medya.png');
*/
