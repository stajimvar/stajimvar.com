...
export const REKLAM_UYGUN_REHBERLER: readonly string[] = [
  'baska-sehirde-staj-barinma',
  'burs-basvurusu-gerekli-belgeler',
  'burs-mulakati',
  'cift-anadal-ve-yan-dal',
  'depozito-ve-kira-sozlesmesi',
  'erasmus-staj-hareketliligi',
  'karsiliksiz-ve-geri-odemeli-burs-farki',
