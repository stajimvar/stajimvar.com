...
export const BOLUM_ALANI = {
  ...
  'hukuk': 'hukuk',
  'yazilim-muhendisligi': 'yazilim',
  'mekatronik-muhendisligi': 'muhendislik',
  'uluslararasi-iliskiler': 'lojistik',
  'iletisim': 'pazarlama',
  'sosyoloji': 'insan-kaynaklari',
  'siyaset-bilimi': 'insan-kaynaklari',
