...
export function toApplicationRecord(row: Tables<'applications'>): ApplicationRecord {
  return {
    ...
    interviewType: row.interview_type ?? undefined,
    interviewLocation: row.interview_location ?? undefined,
    interviewNote: row.interview_note ?? undefined,
    interviewResponse: row.interview_response ?? undefined,
    interviewRespondedAt: row.interview_responded_at ?? undefined,
